    ...
    navbarPage("Next Word ",
               ...
               tabPanel("About",
                        ...
                        div("Next Word is a Shiny app that uses a text
                            ...
                            br(),
                            img(src = "github.png"),
                            a(target = "_blank", href = "https://github.com/bodhi1606/Capstone-Data-Science-JHU/",
                              "Next Word")),
                        br(),
                        h3("About Me"),
                        br(),
                        div("My name is Saurabh kumar Gupta and I have done PGDM from international management 
                        Institute in Finance and Analytics. ",
                            br(),
                            br(),
                            ...
                            a(target = "_blank", href="https://www.linkedin.com/in/saurabh-gupta-730330113/", "Saurabh Kumar Gupta")
                        )        
               )
    )
)
